...
const Cart = () => {
  ...
  /*       const fakeapi = [
          { image: "img/product-1.jpg", title: "Stylish Shirt", price: 123, oldPrice: 150, id: "1" },
          { image: "img/product-2.jpg", title: "Winter Jacket", price: 140, oldPrice: 180, id: "2" },
          ...
          <div className="col-lg-8 table-responsive mb-5">
            <table className="table table-bordered text-center mb-0">
              ...
              <tbody className="align-middle">
                {
                  cartItem?.map(i => (<tr>
                    <td className="align-middle"><img src={`http://localhost:3001/uploads/images/${i?.product?.image}`} alt style={{ width: 50 }} />{i?.product?.name}</td>
